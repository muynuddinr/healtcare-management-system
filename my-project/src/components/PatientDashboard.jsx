...
export default function PatientDashboard({ activeTab = 'overview' }) {
      ...
      case 'prescriptions':
        ...
        return (
          <div className="bg-white dark:bg-secondary-600 rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-6">My Prescriptions</h3>
            ...
            {appointmentsWithPrescriptions.length === 0 ? (
              ...
              <div className="space-y-6">
                {appointmentsWithPrescriptions.map((appointment) => (
                  <div key={appointment._id} className="border dark:border-secondary-500 rounded-lg p-5 bg-gray-50 dark:bg-secondary-500">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <h4 className="text-lg font-medium text-gray-800 dark:text-white">
                          Dr. {appointment.doctor.name}
                        </h4>
                        <p className="text-sm text-gray-500 dark:text-gray-300">{appointment.doctor.department}</p>
                    ...
                    <div className="mt-4">
                      <h5 className="font-medium text-gray-700 dark:text-gray-200 mb-2">Medications</h5>
                    ...
                    {appointment.prescription.notes && (
                      <div className="mt-4">
                        <h5 className="font-medium text-gray-700 dark:text-gray-200 mb-2">Notes</h5>
                        <p className="text-gray-600 dark:text-gray-300">{appointment.prescription.notes}</p>
                      </div>
                    )}
                    
                    {appointment.prescription.followUpDate && (
                      <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/30 rounded border border-blue-100 dark:border-blue-800">
                        <p className="text-blue-700 dark:text-blue-300 font-medium">
                          Follow-up on: {new Date(appointment.prescription.followUpDate).toLocaleDateString()}
                        </p>
                      </div>
                    )}
                  </div>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white dark:bg-secondary-600 rounded-lg shadow-md p-6 mb-8">
        <div className="flex items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          <div className="bg-gray-50 dark:bg-secondary-500 p-4 rounded">
            <p className="text-sm text-gray-500 dark:text-gray-200">Age</p>
            <p className="font-medium dark:text-white">{patient?.age} years</p>
          </div>
          <div className="bg-gray-50 dark:bg-secondary-500 p-4 rounded">
            <p className="text-sm text-gray-500 dark:text-gray-200">Gender</p>
            <p className="font-medium dark:text-white">{patient?.gender}</p>
          </div>
          <div className="bg-gray-50 dark:bg-secondary-500 p-4 rounded">
            <p className="text-sm text-gray-500 dark:text-gray-200">Blood Group</p>

...
import { getDoctorProfile, getDoctorAppointments, updateAppointmentStatus, addPrescription } from '../api/doctorApi';
...
export default function DoctorDashboard() {
  ...
  const handleAddPrescription = async () => {
    try {
      ...
      // Use the imported API function instead of fetch
      const updatedAppointment = await addPrescription(appointmentId, {

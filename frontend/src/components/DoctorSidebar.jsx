  ...
  return (
    <div className={`h-screen bg-white dark:bg-secondary-600 shadow-lg flex flex-col transition-all duration-300 ${collapsed ? 'w-20' : 'w-64'}`}>
      ...
      <div className="flex items-center justify-between p-4 border-b dark:border-secondary-500">
        {!collapsed && <h1 className="text-xl font-bold text-primary-700 dark:text-primary-200">Doctor Portal</h1>}
        <button onClick={() => setCollapsed(!collapsed)} className="p-1 rounded-full hover:bg-gray-100 dark:hover:bg-secondary-500">
          {collapsed ? (
            ...
            <button
              ...
              className={`flex items-center px-4 py-3 w-full text-left rounded-lg ${
                activePage === 'dashboard' 
                  ...
                  : 'text-gray-600 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-secondary-500'
              }`}
            >
      ...
      {/* Logout button */}
      <div className="p-4 border-t dark:border-secondary-500">
        <button
          onClick={handleLogout}
          className="flex items-center px-4 py-3 w-full text-left rounded-lg text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-secondary-500"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
